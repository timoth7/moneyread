...
export const strings = {
  en: {
    ...
    labHome: {
      ...
      traits: 'Traits',
      traitSaver: 'Saver',
      traitExplorer: 'Explorer',
      traitImpulsive: 'Impulsive',
      traitPlanner: 'Planner',
      liveSequence: 'Live sequence',
      recordCount: 'records',
      pattern: 'Pattern',
      evolveInRecords: 'EVOLVE IN {n} MORE RECORDS →',
      evolveMonthly: 'DNA refreshes on the 1st each month →',
      noDnaYet: 'Generate your Spending DNA after 20 records',
      basePairs: 'Base pairs',
      basesLine: '{n} bases',
      incubatorWish: 'Incubator · Wish',
    ...
    profile: {
      ...
      themeSignature: 'Signature', themeLight: 'Light', themeDark: 'Dark', themeLab: 'DNA Lab', clearData: 'Clear local data (dev)',
  ...
  zh: {
    ...
    labHome: {
      ...
      recordCount: '笔记录',
      pattern: '人格标签',
      evolveInRecords: '再记 {n} 笔即可生成消费 DNA →',
      evolveMonthly: '每月 1 日可刷新人格 →',
      noDnaYet: '满 20 笔后生成消费人格',
      basePairs: '碱基对 · 分类',
      basesLine: '{n} 个分类',
      incubatorWish: '培养皿 · 心愿',
      fermenting: '发酵中',
      todayDeposit: '今日存入',
      depositCta: '+ 存入',
      moreWishes: '更多心愿',
      ...
      navDna: '人格',
      level: '等级',
      classicDashboard: '经典首页',
    },
    profile: {
      title: '我的', language: '语言', english: '英文', chinese: '中文', theme: '主题',
      themeSignature: '签名紫', themeLight: '浅色', themeDark: '深色', themeLab: 'DNA 实验室', clearData: '清空本地数据（开发）',
